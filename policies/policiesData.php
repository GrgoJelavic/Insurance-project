        ...
        <form action="insertPolicy.php" method="POST">   
          <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="policyNumber" class="form-control" placeholder="Enter Policy Number" required>
            </div>

            <div class="form-group">
                <label>Type of Insurance</label>
                <input type="text" name="policyType" class="form-control" placeholder="Enter Policy Type" required>
            </div>

            <div class="form-group">
                <label>Customer OIB</label>
                <input type="text" name="oib" class="form-control" placeholder="Enter Customer OIB" required>
            </div>
      ...
      <div class="modal-header">
        ...
        <form action="updatePolicy.php" method="POST">   
          <div class="modal-body">
            ...
            <div class="form-group">
                <label>Policy Number</label>
                <input type="text" name="policyNumber" id="policyNumber" class="form-control" placeholder="Enter Policy Number" required>
            </div>

            <div class="form-group">
                <label>Type of Insurance</label>
                <input type="text" name="policyType" id="policyType"  class="form-control" placeholder="Enter Policy Type" required>
            </div>

            <div class="form-group">
                <label>Oib</label>
                <input type="text" name="oib" id="oib" class="form-control" placeholder="Enter Customer OIB" required>
            </div>
                    ...
                    <table id="dataTableID" class="table table-danger table-bordered">
                      ...
                      <tbody>
                        <tr>                   
                          ...
                          <td><?php echo $row['numberPolicy']; ?></td>
                          <td><?php echo $row['typePolicy'] ?></td>
